...
bool findLeft=1, findRight=1;
//------


//>>>>>LOCAL DO PROJETO<<<<<<
char projectPath[200] = "/home/andrecajus/Desktop/ProjectImgAlgorithm";
...
int main(int argc, char **argv) {
	...
	wd = inotify_add_watch(fd, projectPath, IN_MOVE);
